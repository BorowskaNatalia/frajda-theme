        ...
        <div class="about__info">
            ...
            <div class="about__text">
                <p>
                    ...
                    Radzyminie, z dala od miejskiego zgiełku, tuż przy lesie. Dzięki temu każdego dnia nasi goście mogą
                    odpoczywać blisko natury.
                </p>
            </div>
        </div>
        <div class="about__image">
            <img src="<?= get_template_directory_uri(); ?>/assets/img/onas.jpg"
                alt="Koń i dziewczyna trzymająca rękę na jego nosku" loading="lazy" />
        </div>
    </div>
</section>